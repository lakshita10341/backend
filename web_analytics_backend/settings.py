"""
Django settings for web_analytics_backend project.
...
ROOT_URLCONF = 'web_analytics_backend.urls'
...
# Allow toggling SSL requirement via env; default False so local Docker works
